...
public class BJDataBase : MonoBehaviour {
	...
	void Start () {		
		...
		Creatures.Add (new BJCreature ("Johnny Two Knives", 500, 200, 4, 5, Allegiance.Player, AttackType.Melee, new List<string>{ "Melee attack", "Melee bleed", "Flurry" }));
		Creatures.Add (new BJCreature ("Bill the Bull", 1000, 50, 1, 10, Allegiance.Player, AttackType.Melee, new List<string>{ "Melee attack", "Aggro", "Dodge buff", "Melee stun" }));
