...
public class BJDataBase : MonoBehaviour {
	...
	void Start () {		
		...
		maxHpByLevel = new List<int> { 0, 70, 90, 110, 130, 150, 170, 190, 210, 230, 250 };
		baseDamageByLevel = new List<int> { 0, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60 };
		EnemyCreatures.Add (new BJCreature ("Skeleton militia", maxHpByLevel, maxHpByLevel[1], baseDamageByLevel, 2, 4, Allegiance.Enemy, /*AttackType.Melee,*/ new List<string>{ "Melee attack" }));

		maxHpByLevel = new List<int> { 0, 110, 130, 150, 170, 190, 210, 230, 250, 270, 290 };
		baseDamageByLevel = new List<int> { 0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50 };
		EnemyCreatures.Add (new BJCreature ("Skeleton captain", maxHpByLevel, maxHpByLevel[1], baseDamageByLevel, 4, 1, Allegiance.Enemy, /*AttackType.Melee,*/ new List<string>{ "Melee attack" }));

		maxHpByLevel = new List<int> { 0, 65, 85, 105, 125, 145, 165, 185, 205, 225, 245 };
		baseDamageByLevel = new List<int> { 0, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60 };
		EnemyCreatures.Add (new BJCreature ("Skeleton militia", maxHpByLevel, maxHpByLevel[1], baseDamageByLevel, 3, 4, Allegiance.Enemy, /*AttackType.Melee,*/ new List<string>{ "Melee attack" }));
		...
		EnemyCreatures.Add (new BJCreature ("Skeleton arbalest", maxHpByLevel, maxHpByLevel[1], baseDamageByLevel, 2, 2, Allegiance.Enemy, /*AttackType.Ranged,*/ new List<string>{ "Ranged attack" }));

		maxHpByLevel = new List<int> { 0, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220 };
		baseDamageByLevel = new List<int> { 0, 25, 30, 35, 40, 45, 50, 55, 60, 65, 70 };
		EnemyCreatures.Add (new BJCreature ("Skeleton arbalest", maxHpByLevel, maxHpByLevel[1], baseDamageByLevel, 1, 3, Allegiance.Enemy, /*AttackType.Ranged,*/ new List<string>{ "Ranged attack" }));

		maxHpByLevel = new List<int> { 0, 90, 110, 130, 150, 170, 190, 210, 230, 250, 270 };
		baseDamageByLevel = new List<int> { 0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50 };
		EnemyCreatures.Add (new BJCreature ("Skeleton ogre", maxHpByLevel, maxHpByLevel[1], baseDamageByLevel, 4, 1, Allegiance.Enemy, /*AttackType.Melee,*/ new List<string>{ "Melee attack", "Armor buff" }));
